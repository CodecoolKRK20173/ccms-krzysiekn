...
//        getSqlController().createDB(statement);
//    }
//
...
//        getSqlController().removeWorker("Kamil");
//        assertEquals(getSqlController().getIdByLogin("Kamil"), 0);
//    }
//
//    @Test
//    public void testAddUser() {
//        getSqlController().addWorker(new String[]{"Stefania", "Mentor"});
...
//            getSqlController().findTypeIDbyTypeName("jskadjksj");
//        });
//    }
//
//    @Test
//    public void testEditUser() {
//        getSqlController().editWorker("Magda", "NAME", "Magda2");
//        assertEquals(getSqlController().getIdByName("Magda2"), 2);
//    }
//
//    @Test
//    public void testGetUsersNames() {
//        assertEquals(getSqlController().getWorkersNames("Manager"), new ArrayList<String>(Arrays.asList("Szczepan")));
//    }
}