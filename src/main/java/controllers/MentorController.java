...
public class MentorController {
    ...
    public void run(Mentor mentor) {
        ...
        String[] options = {"View a list of students.","Add an assigment.","Grade an assigment.",
    ...
    private void viewStudents(){
        View.showPersonList(sqlController.getNames("Student"));
    }
    ...
    private void addStudent(){
        ...
        View.printMessage("Please, provide student's email:");
        String email = View.getLoginInput();
        View.printMessage("Please, provide student's password:");
        String password = View.getLoginInput();
        String[] data = {name,"Student",email,password};
...
//        sqlController.remove(getStudentNameFromStudentsList());
